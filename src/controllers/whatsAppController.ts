...
import { generateQRCode, sendMessage, isClientReady } from '../services/whatsAppService.ts';
...
export const isWhatsAppReady = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
  try {
